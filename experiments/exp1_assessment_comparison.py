...
def run_assessment_experiment(dataset_name: str = 'youtube07',
    ...
    if dataset_name == 'youtube07':
        ...
        loader = MovieLensLoader(DATASETS['movielens'])
    else:
    ...
    try:
        ...
        print(f"Error: Dataset not found at {DATASETS[dataset_name]['path']}")
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Run assessment comparison experiment')
    parser.add_argument('dataset', type=str, nargs='?', default='youtube07',
                       help='Dataset name (youtube07, youku, movielens)')
    parser.add_argument('num_items', type=int, nargs='?', default=1000,
                       help='Number of items to test (0 for all items)')
